...
A pasta `Subscriptions` consulta a assinatura ativa da organização atual. Depois
do onboarding ela deve retornar o plano `Free`; não há mudança ou cobrança de
plano nesta fase.
