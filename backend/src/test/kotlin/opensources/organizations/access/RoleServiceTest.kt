...
class RoleServiceTest {
    ...
    private val customPermission = permission(organizationId, "opensources.manage")
    ...
    fun `replaces permissions only with permissions available to the organization`() =
        runTest {
            ...
            assertEquals(setOf("members.read", "opensources.manage"), response.data.map { it.key }.toSet())
